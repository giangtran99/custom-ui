...
export interface UseCarouselBarProps {
}

export function useCarouselBar(props: UseCarouselBarProps) {
  return {};
}

export type UseCarouselBarReturn = ReturnType<typeof useCarouselBar>