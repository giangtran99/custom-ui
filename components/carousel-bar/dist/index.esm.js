...
function styled(component, options) {
  ...
  const chakraComponent = React22.forwardRef(function ChakraComponent(props, ref) {
    const { colorMode, forced } = useColorMode();
    return React22.createElement(Component, {
      ref,
...
var fallbackIcon = {
  path: /* @__PURE__ */ React3.createElement("g", {
    stroke: "currentColor",
    strokeWidth: "1.5"
...
var Icon = forwardRef((props, ref) => {
  ...
  if (element && typeof element !== "string") {
    return /* @__PURE__ */ React3.createElement(chakra.svg, {
      as: element,
      ...shared,
      ...rest
    });
...
import {
  createContext as createReactContext2,
  useContext as useReactContext2
} from "react";
...
function createContext3(options = {}) {
  ...
  const Context = createReactContext2(void 0);
  Context.displayName = name;
  function useContext3() {
    var _a;
    const context = useReactContext2(Context);
    if (!context && strict) {
...
var Tag = forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ React4.createElement(TagStylesProvider, {
    value: styles
  }, /* @__PURE__ */ React4.createElement(chakra.span, {
    ref,
    ...ownProps,
...
var TagLabel = forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ React4.createElement(chakra.span, {
    ref,
    noOfLines: 1,
    ...props,
    __css: styles.label
...
var TagLeftIcon = forwardRef((props, ref) => /* @__PURE__ */ React4.createElement(Icon, {
  ref,
  verticalAlign: "top",
  marginEnd: "0.5rem",
  ...props
...
var TagRightIcon = forwardRef((props, ref) => /* @__PURE__ */ React4.createElement(Icon, {
  ref,
  verticalAlign: "top",
  marginStart: "0.5rem",
  ...props
...
var TagCloseIcon = (props) => /* @__PURE__ */ React4.createElement(Icon, {
...
var TagCloseButton = forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ React4.createElement(chakra.button, {
    ref,
    "aria-label": "close",
    ...rest,
    type: "button",
    disabled: isDisabled,
    __css: btnStyles
  }, children || /* @__PURE__ */ React4.createElement(TagCloseIcon, null));
});
...
function CarouselBar({ listItems, title = "Game On Sales" }) {
  const [itemsPerPage, setItemsPerPage] = useState2(5);
  const numberOfPage = Math.ceil(listItems.length / itemsPerPage);
  const currentFrameRef = useRef2(1);
  useEffect3(() => {
    onResize();
  }, []);
  const onResize = () => {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxs("div", {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsx("p", {
                            className: "text-base",
                            children: getElipsisString(item.name, 34)
                          }),
                          /* @__PURE__ */ jsxs("div", {
                              ...
                              /* @__PURE__ */ jsx("div", {
                                ...
                                children: /* @__PURE__ */ jsxs("div", {
                                  ...
                                  children: [
                                    ...
                                    /* @__PURE__ */ jsx("p", {
                                      className: "text-sm",
                                      children: `${formatMoney(item.price / 2)}`
                                    })
                                  ]
                                })
                              })
