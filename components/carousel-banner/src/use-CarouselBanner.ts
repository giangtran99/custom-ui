...
export interface UseCarouselBannerProps {
}

export function useCarouselBanner(props: UseCarouselBannerProps) {
  return {};
}

export type UseCarouselBannerReturn = ReturnType<typeof useCarouselBanner>